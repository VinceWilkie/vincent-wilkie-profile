            ...
            <div className="relative z-10 flex items-start justify-center min-h-screen py-8 px-4">
                <div className="max-w-2xl w-full bg-black/70 backdrop-blur-md rounded-2xl border border-green-500/20 overflow-hidden">
                    ...
                    <div className="px-6 py-6">
                        <h2 className="text-green-400 text-xs uppercase tracking-wider font-semibold mb-4">Skills</h2>
                        <div className="space-y-4">
                            {skills.map((group) => (
                                <div key={group.category}>
                                    <h3 className="text-green-400 text-xs uppercase tracking-wider mb-2">{group.category}</h3>
                    ...
                    {/* Projects */}
                    <div className="px-6 py-6">
                        <h2 className="text-green-400 text-xs uppercase tracking-wider font-semibold mb-4">Projects</h2>
                        <div className="space-y-4">
                            {projects.map((project) => (
                                <div key={project.name} className="flex items-center gap-4">
                                    <Image
                                        ...
                                        width={64}
                                        height={64}
                                        className="w-16 h-16 rounded-lg object-contain bg-black/50"
                                    />
